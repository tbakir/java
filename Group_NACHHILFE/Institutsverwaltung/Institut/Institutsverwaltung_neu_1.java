...
public class Institutsverwaltung_neu_1 
{
    public static void main(String[] args) 
    {
        ...
        for (Personen x:p)
        {
            ...
            }                                       // Mitarbeiter existiert eine Methode
                                                    // getGehalt(), also Aufruf o.k.
            else if (x instanceof Trainer)
            {
                Trainer tr = (Trainer)x;  // Erlaubter Down-Cast mit explizitem Casting
                System.out.println(tr.getGehalt());
            }
            else if (x instanceof Teilnehmer)
            {
                Teilnehmer tn = (Teilnehmer)x;  // Erlaubter Down-Cast mit explizitem Casting
                System.out.println(tn.getGehalt());
            }
            else
                ;
        }    
